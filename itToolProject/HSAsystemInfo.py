...
def main():
    ...
    myoginstall = myoginstall[0].strip()  
    ...
    install_frame.place(relwidth=0.3, relheight=0.2, relx=0.55,rely=0.50)                           # Defining size/centering and loading into canvas                                                            # Deleteing white spaces or new lines
